...
#'
#' smooth() generates a spline model with the input dose and response,
...
#' @keywords internal
#' @import car clinfun multcomp pgirmess DTK mgcv segmented mvtnorm
NULL
